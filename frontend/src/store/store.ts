...
export const useStore = defineStore('store', () => {
    ...
    async function saveCategoriesForDate(date: CalendarDate, categories: CategoryEntry[])  {
        // TODO:
    ...
    return { categoriesForDate, saveCategoriesForDate, getCategoriesForDate, changeSelectedDate, currentDate };
});
