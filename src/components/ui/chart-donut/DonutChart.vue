      ...
      <VisDonut
        ...
        :events="{
          [Donut.selectors.segment]: {
            ...
            mouseover: (d: Data, ev: PointerEvent, i: number, elements: HTMLElement[]) => {
              elements.forEach(el => el.style.opacity = `${filterOpacity}`)
              elements[i].style.opacity = '1'  // Das gehighlightete Segment bleibt sichtbar
            },
            mouseout: (d: Data, ev: PointerEvent, i: number, elements: HTMLElement[]) => {
              elements.forEach(el => el.style.opacity = '1') // Alle Segmente wieder normal sichtbar machen
            }
          },
        }"
      />
